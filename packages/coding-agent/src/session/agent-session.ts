...
export class AgentSession {
 ...
 async sendUserMessage(
  ...
  if (options?.deliverAs === "followUp") {
   await this.#queueUserMessage(text, images, "followUp", undefined, undefined, attachments);
   return;
  }
  if (options?.deliverAs === "steer") {
   await this.#queueUserMessage(text, images, "steer", undefined, undefined, attachments);
   return;
  }
